# https://medium.com/psicodata/analisando-conversas-de-whatsapp-no-r-c3-a7-c3-a3o-digital-2243104f0a05
...
to_remove <- c(stopwords('pt'),"q",'w',"htps","pra","tá","vc","k","n","nao","sim","Arquivo","de","mídia","oculto","arquivo","c",'ta','to','vou','tão','pq','eh','https','ja','tb',"tbm","vai","iso","mto","isso","acho","td","haha","hahaha",'rsrs','kk','é','ti','tô')
words <- chat %>%
  filter(!is.na(text)) %>% 
